<div class="flex items-center justify-center min-h-screen bg-gray-100 font-mono">
    <div class="px-8 py-6 mx-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
        ...
        echo $form->newField($model, 'name') ?>
        <?php echo $form->newField($model, 'email') ?>
        <?php echo $form->newField($model, 'password')->setTypePass() ?>
        <?php echo $form->newField($model, 'confirmPassword')->setTypePass() ?>
        <div class="mt-4">
            <div class="flex">
            ...
            <div class="mt-6 text-grey-dark">
                ...
                <a class="text-blue-600 hover:underline" href="/php-mvc/login/">
                    ورود
                </a>
            </div>
        </div>
